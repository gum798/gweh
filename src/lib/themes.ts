...
export const lightOverrides: Record<ThemeKey, Partial<ThemeDefinition>> = {
  cosmic: {
    ...
    '--bg-hero-bottom': '#faf8f5',
    '--bg-hero-mid': 'rgba(250, 248, 245, 0.6)',
    '--accent': '#c4960a',
    '--accent-hover': '#a87e08',
    '--accent-glow': 'rgba(196, 150, 10, 0.35)',
    '--accent-10': 'rgba(196, 150, 10, 0.1)',
    '--accent-20': 'rgba(196, 150, 10, 0.18)',
    '--accent-30': 'rgba(196, 150, 10, 0.26)',
    '--accent-40': 'rgba(196, 150, 10, 0.35)',
    '--accent-50': 'rgba(196, 150, 10, 0.45)',
    '--scrollbar-track': '#ece8e2',
    '--scrollbar-thumb': '#c4960a',
    '--scrollbar-thumb-hover': '#a87e08',
    '--glow-1': '0 0 6px rgba(196,150,10,0.25), 0 0 12px rgba(196,150,10,0.12)',
    '--glow-2': '0 0 18px rgba(196,150,10,0.2), 0 0 30px rgba(196,150,10,0.1)',
    '--text-glow': 'rgba(196, 150, 10, 0.35)',
    '--glass-border': 'rgba(196, 150, 10, 0.25)',
    '--text-primary': '#1a1a2e',
    '--text-secondary': 'rgba(26, 26, 46, 0.75)',
    '--text-muted': 'rgba(26, 26, 46, 0.55)',
    '--text-faint': 'rgba(26, 26, 46, 0.35)',
    '--border-default': 'rgba(196, 150, 10, 0.15)',
    '--surface-overlay': 'rgba(196, 150, 10, 0.04)',
    '--surface-elevated': 'rgba(196, 150, 10, 0.07)',
  },
  celestial: {
    '--bg-primary': '#f4f7fc',
    '--bg-panel': 'rgba(255, 255, 255, 0.82)',
    '--bg-panel-solid': '#ffffff',
    '--bg-hero-bottom': '#f4f7fc',
    '--bg-hero-mid': 'rgba(244, 247, 252, 0.6)',
    '--accent': '#2563eb',
    '--accent-hover': '#1d4ed8',
    '--accent-glow': 'rgba(37, 99, 235, 0.35)',
    '--accent-10': 'rgba(37, 99, 235, 0.1)',
    '--accent-20': 'rgba(37, 99, 235, 0.18)',
    '--accent-30': 'rgba(37, 99, 235, 0.26)',
    '--accent-40': 'rgba(37, 99, 235, 0.35)',
    '--accent-50': 'rgba(37, 99, 235, 0.45)',
    '--scrollbar-track': '#e5e9f0',
    '--scrollbar-thumb': '#2563eb',
    '--scrollbar-thumb-hover': '#1d4ed8',
    '--glow-1': '0 0 6px rgba(37,99,235,0.2), 0 0 12px rgba(37,99,235,0.1)',
    '--glow-2': '0 0 18px rgba(37,99,235,0.15), 0 0 30px rgba(37,99,235,0.08)',
    '--text-glow': 'rgba(37, 99, 235, 0.3)',
    ...
    '--surface-overlay': 'rgba(37, 99, 235, 0.04)',
    '--surface-elevated': 'rgba(37, 99, 235, 0.07)',
  },
  ember: {
    '--bg-primary': '#fcf6f4',
    '--bg-panel': 'rgba(255, 255, 255, 0.82)',
    '--bg-panel-solid': '#ffffff',
    '--bg-hero-bottom': '#fcf6f4',
    '--bg-hero-mid': 'rgba(252, 246, 244, 0.6)',
    '--accent': '#c42020',
    '--accent-hover': '#a51a1a',
    '--accent-glow': 'rgba(196, 32, 32, 0.35)',
    '--accent-10': 'rgba(196, 32, 32, 0.1)',
    '--accent-20': 'rgba(196, 32, 32, 0.18)',
    '--accent-30': 'rgba(196, 32, 32, 0.26)',
    '--accent-40': 'rgba(196, 32, 32, 0.35)',
    '--accent-50': 'rgba(196, 32, 32, 0.45)',
    '--scrollbar-track': '#f0e8e5',
    '--scrollbar-thumb': '#c42020',
    '--scrollbar-thumb-hover': '#a51a1a',
    '--glow-1': '0 0 6px rgba(196,32,32,0.2), 0 0 12px rgba(196,32,32,0.1)',
    '--glow-2': '0 0 18px rgba(196,32,32,0.15), 0 0 30px rgba(196,32,32,0.08)',
    '--text-glow': 'rgba(196, 32, 32, 0.3)',
    '--glass-border': 'rgba(196, 32, 32, 0.2)',
    '--text-primary': '#1a1a2e',
    '--text-secondary': 'rgba(26, 26, 46, 0.75)',
    '--text-muted': 'rgba(26, 26, 46, 0.55)',
    '--text-faint': 'rgba(26, 26, 46, 0.35)',
    '--border-default': 'rgba(196, 32, 32, 0.12)',
    '--surface-overlay': 'rgba(196, 32, 32, 0.04)',
    '--surface-elevated': 'rgba(196, 32, 32, 0.07)',
  },
  jade: {
    '--bg-primary': '#f4faf6',
    '--bg-panel': 'rgba(255, 255, 255, 0.82)',
    '--bg-panel-solid': '#ffffff',
    '--bg-hero-bottom': '#f4faf6',
    '--bg-hero-mid': 'rgba(244, 250, 246, 0.6)',
    '--accent': '#0a8a5e',
    '--accent-hover': '#067a50',
    '--accent-glow': 'rgba(10, 138, 94, 0.35)',
    '--accent-10': 'rgba(10, 138, 94, 0.1)',
    '--accent-20': 'rgba(10, 138, 94, 0.18)',
    '--accent-30': 'rgba(10, 138, 94, 0.26)',
    '--accent-40': 'rgba(10, 138, 94, 0.35)',
    '--accent-50': 'rgba(10, 138, 94, 0.45)',
    '--scrollbar-track': '#e0ede5',
    '--scrollbar-thumb': '#0a8a5e',
    '--scrollbar-thumb-hover': '#067a50',
    '--glow-1': '0 0 6px rgba(10,138,94,0.2), 0 0 12px rgba(10,138,94,0.1)',
    '--glow-2': '0 0 18px rgba(10,138,94,0.15), 0 0 30px rgba(10,138,94,0.08)',
    '--text-glow': 'rgba(10, 138, 94, 0.3)',
    '--glass-border': 'rgba(10, 138, 94, 0.2)',
    '--text-primary': '#1a1a2e',
    '--text-secondary': 'rgba(26, 26, 46, 0.75)',
    '--text-muted': 'rgba(26, 26, 46, 0.55)',
    '--text-faint': 'rgba(26, 26, 46, 0.35)',
    '--border-default': 'rgba(10, 138, 94, 0.12)',
    '--surface-overlay': 'rgba(10, 138, 94, 0.04)',
    '--surface-elevated': 'rgba(10, 138, 94, 0.07)',
  },
};
